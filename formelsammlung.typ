...
// Version
#let version = sys.inputs.at("version", default: "NN")
  ...
  - *Mechanik*:
    - Zeichnen Sie den Situationsplan und bei gerichteten Grössen (wie Kräfte #text(fill: red)[$arrow(F)$], Geschwindigkeiten #text(fill: blue)[$arrow(v)$] oder Impulsen #text(fill: blue)[$arrow(p)$]) den Additionsplan: #v(-.5em) #align(center)[
        #cetz.canvas({
          ...
          line((0, 0.1), (rel: (0, -1)), mark: (end: "barbed", size: 8pt), stroke: red, name: "F_G")

          line((0, 0.1), (rel: (FR, FR_b)), mark: (end: "barbed", size: 8pt), stroke: red, name: "F_R")

          line((0.0, 0.1), (rel: (FN, FN_b)), stroke: red, mark: (end: "barbed", size: 8pt), name: "F_N")
          ...
          line((3.5, 0.5), (rel: (0, -1.5)), mark: (end: "barbed", size: 8pt), stroke: red, name: "F_G")

          line((), (rel: (FN, 1.5 * FN_b)), mark: (end: "barbed", size: 8pt), stroke: red, name: "F_N")

          line((), (3.5, 0.5), mark: (end: "barbed", size: 8pt), stroke: red, name: "F_R")
...
#grid(
  ...
  [Kreisumfang], [$#text(fill: purple)[$U$] = 2 pi #text(fill: green)[$r$]=pi #text(fill: blue)[$d$]$], grid.cell(
    rowspan: 6,
  )[#cetz.canvas({
    import cetz.draw: *
...
#grid(
  ..mathe,
  [], [$sin alpha=#text(fill: blue)[Gegenkathete]/#text(fill: red)[Hypotenuse]=#text(fill: blue)[$a$]/#text(fill: red)[$c$]$], grid.cell(
    rowspan: 4,
  )[#cetz.canvas({
    import cetz.draw: *
  ...
  [], [$tan alpha=#text(fill: blue)[Gegenkathete]/#text(fill: green)[Ankathete]=#text(fill: blue)[$a$]/#text(fill: green)[$b$]$#v(
      1em,
    )],
...
#grid(
  ...
  [Addition], grid.cell(
    colspan: 2,
  )[$sin(alpha plus.minus beta)=sin alpha dot cos beta plus.minus cos alpha dot sin beta$],
...
#grid(
  ...
  [Kräftegleichgewicht], grid.cell(
    colspan: 3,
  )[Ein Körper ist im Kräftegleichgewicht, wenn die resultierende Kraft $#text(fill: red)[$arrow(F)_"res"$]$ Null ist.],
  [], grid.cell(colspan: 3)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: 0.5pt)
  ...
  [Drehmoment], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$M$]=#text(fill: red)[$F$] #text(fill: green)[$r$]$], [$[M]=qty("1", "Newton meter")$],
  ...
  [Momenten-#linebreak()gleichgewicht #v(1em)], grid.cell(
    colspan: 3,
  )[$sum #text(fill: red)[$M_"linksdrehend"$]=sum #text(fill: red)[$M_"rechtsdrehend"$]$],

  [Gleichgewichtsarten], grid.cell(colspan: 3)[stabil, labil, indifferent #v(1em)],

  [Hebelgesetz], grid.cell(
    colspan: 3,
  )[$#text(fill: red)[$F_1$] #text(fill: green)[$r_1$] = #text(fill: red)[$F_2$] #text(fill: green)[$r_2$]$],
  [], [#text(fill: green)[$r_i$]], [Kraftarme#v(1em)], [$[r_i]=qty("1", "m")$],

  [Schwerpunkt], grid.cell(
    colspan: 2,
  )[$x_s=(sum x_i m_i)/(sum m_i)$; $y_s=(sum y_i m_i)/(sum m_i)$], [$[m_i]=qty("1", "kg")$],
  ...
  [Schiefe Ebene], grid.cell(
    colspan: 3,
  )[$#text(fill: red)[$F_||$]/#text(fill: red)[$F_G$]=#text(fill: blue)[Gegenkathete]/#text(fill: red)[Hypotenuse]=#text(fill: blue)[$a$]/#text(fill: red)[$c$]=sin alpha$],
  grid.cell(rowspan: 3)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: 0.5pt)
      ...
      line(
        "gegenstand.center",
        (rel: (90deg + alfa, -betrag * calc.cos(alfa))),
        stroke: red,
        mark: (end: "barbed", scale: 0.5),
        name: "F_senkrecht",
      )
      line(
        "gegenstand.center",
        (rel: (alfa, -betrag * calc.sin(alfa))),
        stroke: red,
        mark: (end: "barbed", scale: 0.5),
        name: "F_parallel",
      )
    ...
    colspan: 3,
  )[$#text(fill: red)[$F_perp$]/#text(fill: red)[$F_G$]=#text(fill: green)[Ankathete]/#text(fill: red)[Hypotenuse]=#text(fill: green)[$b$]/#text(fill: red)[$c$]=cos alpha$],
...
#grid(
  ...
  [], text(fill: red)[$g$], grid.cell(
    colspan: 2,
  )[Ortsfaktor/Fallbeschleunigung#linebreak()$qty("9.81", "N/kg")=qty("9.81", "m/s^2")$#v(1em)],
  ...
  [Normalkraft], grid.cell(
    colspan: 3,
  )[Die Kraft, mit der zwei Körper senkrecht zur Berührungsfläche aufeinander einwirken.#v(1em)],

  [Gleitreibungskraft], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F_R$]=mu_G #text(fill: red)[$F_N$]$], [$[F_R]=qty("1", "N")$],
  [], [$mu_G$], [Gleitreibungszahl], [$[mu_G]=1$],
  [], text(fill: red)[$F_N$], [Normalkraft#v(1em)], [$[F_N]=qty("1", "N")$],

  [Haftkraft], grid.cell(
    colspan: 2,
  )[$0<=#text(fill: red)[$F_R$]<=mu_H #text(fill: red)[$F_N$]$], [$[F_R]=qty("1", "N")$],
...
#grid(
  ...
  [Schweredruck], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$p$]=rho #text(fill: red)[$g$] #text(fill: green)[$h$]$], [$[p]=qty("1", "Pa")$],
  ...
  [Gesamtdruck], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$p_"tot"$]=#text(fill: blue)[$p_0$]+rho #text(fill: red)[$g$] #text(fill: green)[$h$]$], [$[p_"tot"]=qty("1", "Pa")$],
  [], text(
    fill: blue,
  )[$p_0$], [Luftdruck: $qty("1", "atm")$, wenn nichts angegeben ist#v(1em)], [$[p_0]=qty("1", "Pa")$],

  [Auftrieb <F_A>], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F_A$]=rho #text(fill: red)[$g$] #text(fill: purple)[$V_E$]$], [$[F_A]=qty("1", "N")$],
  grid.cell(rowspan: 3)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: 0.5pt)
  ...
  [Gesetz von #smallcaps[Bernoulli]], grid.cell(
    colspan: 3,
  )[$#text(fill: blue)[$p$]+1/2 rho #text(fill: blue)[$v$]^2+rho #text(fill: red)[$g$] #text(fill: green)[$h$]="konstant"$],
...
#grid(
  ..standard,
  [Gleichförmig], grid.cell(colspan: 3)[ #grid(
      columns: (1fr, 1fr),
      // x-t-Diagramm
      [#cetz.canvas({
        import cetz-plot: *
        ...
        plot.plot(
          ...
          y-tick-step: none,
          x-label: [$t$],
          y-label: text(fill: green)[$x$],
          x-ticks: ((1, [$t$]),),
          y-ticks: ((0.3, [#text(fill: green)[$x_0$]]),),
          name: "xt",
          {
      ...
      [#cetz.canvas({
        ...
        plot.plot(
          ...
          y-tick-step: none,
          x-label: [$t$],
          y-label: text(fill: blue)[$v$],
          x-ticks: ((1, [$t$]),),
          y-ticks: ((0.8, [#text(fill: blue)[$v_0$]]),),
          name: "vt",
          {
            plot.add(((0, 0.8), (1, 0.8)), style: (stroke: blue))
            plot.add-fill-between(((0, 0.8), (1, 0.8)), ((0, 0), (1, 0)), style: (
              stroke: none,
  ...
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$x$]=#text(fill: green)[$x_0$]+#text(fill: green)[$Delta x$]=#text(fill: green)[$x_0$]+#text(fill: blue)[$v_0$]t$], [$[x]=qty("1", "m")$],
  ...
  [ #grid(
      ...
      [#cetz.canvas({
        ...
        plot.plot(
          ...
          y-label: text(fill: blue)[$v$],
          x-ticks: ((1, [$t$]),),
          y-ticks: ((0.3, [#text(fill: blue)[$v_0$]]),),
          name: "vt",
          {
            plot.add(((0, 0.3), (1.1, 1)), style: (stroke: blue))
            plot.add-fill-between(((0, 0.3), (1, 0.93)), ((0, 0), (1, 0)), style: (
              stroke: none,
              fill: green.transparentize(80%),
            ))
            plot.add(((1, 0), (1, 0.3)), style: (stroke: (paint: black, dash: "dashed")))
      ...
      [#cetz.canvas({
        ...
        plot.plot(
          ...
          y-tick-step: none,
          x-label: [$t$],
          y-label: text(fill: red)[$a$],
          x-ticks: ((1, [$t$]),),
          y-ticks: ((0.8, [#text(fill: red)[$a$]]),),
          name: "at",
          {
...
#grid(
  ...
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$x$]=#text(fill: green)[$x_0$]+#text(fill: green)[$Delta x_1$]+#text(fill: green)[$Delta x_2$]=#text(fill: green)[$x_0$]+#text(fill: blue)[$v_0$]t+1/2#text(fill: red)[$a$]t^2$], [$[x]=qty("1", "m")$],
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$v$]=#text(fill: blue)[$v_0$]+#text(fill: blue)[$Delta v$]=#text(fill: blue)[$v_0$]+#text(fill: red)[$a$]t$], [$[v]=qty("1", "m/s")$],
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$dash(v)$]=(#text(fill: green)[$Delta x$])/(Delta t)$], [$[dash(v)]=qty("1", "m/s")$],
  [], grid.cell(
    colspan: 3,
  )[$2#text(fill: red)[$a$] (#text(fill: green)[$x$]-#text(fill: green)[$x_0$])=#text(fill: blue)[$v$]^2-#text(fill: blue)[$v_0$]^2$],
  ...
  grid.cell(rowspan: 2)[Horizontaler Wurf#linebreak()für $x_0=0$ und $y_0=h$], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$x$]=#text(fill: blue)[$v_0$]t$], [$[x]=qty("1", "m")$],
  grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$y$]=#text(fill: green)[$h$]-1/2#text(fill: red)[$g$]t^2$], [$[y]=qty("1", "m")$],
  [], text(fill: blue)[$v_0$], [Anfangsgeschwindigkeit], [$[v_0]=qty("1", "m/s")$],
  [], text(fill: green)[$h$], [Abwurfhöhe], [$[h]=qty("1", "m")$],
  [], text(
    fill: red,
  )[$g$], [Ortsfaktor/Fallbeschleunigung#linebreak()$qty("9.81", "N/kg")=qty("9.81", "m/s^2")$], [$[g]=qty("1", "m/s^2")$]
)
#pagebreak()
...
#grid(
  ...
  grid.cell(rowspan: 3)[Winkelkoordinate \
      ...
      #cetz.canvas({
        ...
        on-layer(-1, {
          cetz.angle.angle(
            ...
            radius: 0.5,
            label-radius: 0.34,
            label: box(baseline: -0.2em)[#text(fill: winkel)[$phi$]],
            stroke: winkel,
          )
        })
    ...
    colspan: 2,
  )[$#text(fill: winkel)[$phi$]=#text(fill: aqua)[$b$]/#text(fill: green)[$r$]$], [$[phi]=qty("1", "")$],
  text(fill: aqua)[$b$], [Bogenlänge], [$[b]=qty("1", "m")$],
  text(fill: green)[$r$], [Kreisradius#v(1em)], [$[r]=qty("1", "m")$],

  [Winkelgeschwindigkeit], grid.cell(
    colspan: 2,
  )[$#text(fill: purple)[$omega$]=(#text(fill: winkel)[$Delta phi$])/(Delta t)$], [$[omega]=qty("1", "1/s")$],
  [], text(
    fill: winkel,
  )[$Delta phi$], [Drehwinkel (Bogenmass!), der \ in der Zeitspanne $Delta t$ überstrichen wird#v(1em)], [$[phi]=1$],

  [Bahngeschwindigkeit#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$v$]=#text(fill: purple)[$omega$]#text(fill: green)[$r$]$], [$[v]=qty("1", "m/s")$],

  [Umlaufzeit, Periode#v(1em)], grid.cell(
    colspan: 2,
  )[$T=(2 pi #text(fill: green)[$r$])/#text(fill: blue)[$v$]=(2 pi)/#text(fill: purple)[$omega$]$], [$[T]=qty("1", "s")$],

  [Frequenz, Drehzahl#v(1em)], grid.cell(colspan: 2)[$f=1/T$], [$[f]=qty("1", "Hz")$],

  [Zentripetalbeschl.#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$a_z$]=#text(fill: blue)[$v$]^2/#text(fill: green)[$r$]=#text(fill: purple)[$omega$]^2#text(fill: green)[$r$]$], [$[a_z]=qty("1", "m/s^2")$]
)
...
#grid(
  ..standard,
  [Winkelbeschleunigung#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$alpha$]=(#text(fill: purple)[$Delta omega$])/(Delta t)$], [$[alpha]=qty("1", "1/s^2")$],

  [Bahnbeschleunigung#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$a$]=#text(fill: red)[$alpha$]#text(fill: green)[$r$]$], [$[a]=qty("1", "m/s^2")$],

  [Bewegungsgleichungen], grid.cell(
    colspan: 2,
  )[$#text(fill: winkel)[$phi$]=#text(fill: winkel)[$phi_0$]+#text(fill: purple)[$omega_0$]t+1/2#text(fill: red)[$alpha$]t^2$], [$[phi]=qty("1", "")$],
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: purple)[$omega$]=#text(fill: purple)[$omega_0$]+#text(fill: red)[$alpha$]t$], [$[omega]=qty("1", "1/s")$],
...
#grid(
  ..standard,
  [Trägheitsprinzip], grid.cell(
    colspan: 3,
  )[Ein Körper, auf den keine Kraft wirkt, führt eine geradlinige, gleichförmige Bewegung aus oder verharrt in Ruhe.#v(1em)],

  [Aktionsprinzip], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$arrow(F)_"res"$]=m#text(fill: red)[$arrow(a)$]$], [$[F_"res"]=qty("1", "N")$],
  [], text(fill: red)[$arrow(F)_"res"$], [resultierende Kraft], [],
  [], [$m$], [Masse des Körpers], [$[m]=qty("1", "kg")$],
  [], text(fill: red)[$arrow(a)$], [Beschleunigung des Körpers#v(1em)], [$[a]=qty("1", "m/s^2")$],

  [Wechselwirkungsprinzip#v(1em)], grid.cell(
    colspan: 3,
  )[$#text(fill: red)[$arrow(F)_"1 auf 2"$]=-#text(fill: red)[$arrow(F)_"2 auf 1"$]$]
)
...
#grid(
  ..standard,
  [Zentripetalkraft], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F_z$]=m#text(fill: purple)[$omega$]^2#text(fill: green)[$r$]=m (#text(fill: blue)[$v$]^2)/#text(fill: green)[$r$]$], [$[F_z]=qty("1", "N")$],
...
#grid(
  ..standard,
  [Grundgleichung], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$M_"res"$]=J#text(fill: red)[$alpha$]$], [$[M_"res"]=qty("1", "N m")$],
  ...
  [Satz von #smallcaps[Steiner]], grid.cell(
    colspan: 2,
  )[$J=J_"SP"+m#text(fill: green)[$r$]^2$], [$[J]=qty("1", "kg m^2")$],
...
#grid(
  ..standard,
  [Gravitationskraft], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F_G$]=G (m_1 m_2)/#text(fill: green)[$r$]^2$], [$[F_G]=qty("1", "N")$],
...
#grid(
  ..standard,
  [1. #smallcaps[Keplersches] Gesetz], grid.cell(
    colspan: 3,
  )[Planeten bewegen sich auf Ellipsen. Die Sonne befindet sich in einem Brennpunkt der Ellipse#v(1em)],

  [2. #smallcaps[Keplersches] Gesetz], grid.cell(
    colspan: 3,
  )[Die Verbindungslinie zwischen Sonne und Planet überstreicht in gleichen Zeitspannen $Delta t$ gleiche Flächeninhalte #text(fill: red)[$Delta A$].],
  grid.cell(colspan: 4)[
    #align(center)[
      #cetz.canvas({
        import cetz.draw: *
  ...
  [3. #smallcaps[Keplersches] Gesetz], grid.cell(
    colspan: 3,
  )[$T_1^2/T_2^2=#text(fill: aqua)[$a_1$]^3/#text(fill: aqua)[$a_2$]^3$],
  [], text(fill: aqua)[$a_i$], [grosse Halbachse der Planeten], [$[a_i]=qty("1", "m")$],
  [], [$T_i$], [Umlaufzeit der Planeten#v(1em)], [$[T_i]=qty("1", "s")$],

  [Numerische Exzentrizität], grid.cell(
    colspan: 2,
  )[$epsilon=#text(fill: purple)[$e$]/#text(fill: aqua)[$a$]$], [$[epsilon]=qty("1", "1")$],
  [], text(
    fill: purple,
  )[$e$], [lineare Exzentrizität#linebreak()$#text(fill: purple)[$e$]^2=#text(fill: aqua)[$a$]^2-#text(fill: blue)[$b$]^2$], [$[e]=qty("1", "m")$],
...
#grid(
  ..standard,
  [Definition], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$W$]=#text(fill: red)[$F_s$]#text(fill: green)[$s$]$], [$[W]=qty("1", "J")$],
  grid.cell(rowspan: 2)[
    #cetz.canvas({
      import cetz-plot: *
      import cetz.draw: *
      ...
      plot.plot(
        ...
        x-tick-step: none,
        y-tick-step: none,
        x-label: text(fill: green)[$s$],
        y-label: text(fill: red)[$F_s$],
        name: "Fs",
        {
          plot.add(((0, 0.8), (1, 0.8)), style: (stroke: red))
          plot.add(((0, 0), (0, 1)), style: (stroke: none))
...
#grid(
  ...
  [Definition], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$Delta E$]=#text(fill: aqua)[$W$]$], [$[Delta E]=qty("1", "J")$],
  [$$#v(1em)], text(fill: aqua)[$W$], [Arbeit], [$[W]=qty("1", "J")$],

  [Lageenergie], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$E_"pot"$]=m g#text(fill: green)[$h$]$], [$[E_"pot"]=qty("1", "J")$],
  grid.cell(rowspan: 3)[
    #align(center)[
      #cetz.canvas({
        import cetz.draw: *
  ...
  [Bewegungsenergie], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$E_"kin"$]=1/2 m #text(fill: blue)[$v$]^2$], [$[E_"kin"]=qty("1", "J")$],
  grid.cell(rowspan: 2)[
    #align(center)[
      #cetz.canvas({
        import cetz.draw: *
  ...
  [Spannenergie], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$E_"spann"$]=1/2 D#text(fill: red)[$y$]^2$], [$[E_"spann"]=qty("1", "J")$],
  grid.cell(rowspan: 2)[
    #align(center)[
      #cetz.canvas({
        import cetz.draw: *
  ...
  [Rotationsenergie], grid.cell(
    colspan: 2,
  )[$#text(fill: purple)[$E_"rot"$]=1/2 J#text(fill: purple)[$omega$]^2$], [$[E_"rot"]=qty("1", "J")$],
  ...
  [Energieerhaltung], grid.cell(
    colspan: 3,
  )[In einem abgeschlossenen System bleibt die Gesamtenergie $E_"tot"$ erhalten.#v(1em)]
)
...
#grid(
  ..standard,
  [Mittlere Leistung], grid.cell(
    colspan: 2,
  )[$P=(#text(fill: aqua)[$Delta E$])/(Delta t)=#text(fill: red)[$F$]#text(fill: blue)[$v$]$], [$[P]=qty("1", "W")$],
  grid.cell(rowspan: 3)[
    #cetz.canvas({
      import cetz-plot: *
      import cetz.draw: *
      ...
      plot.plot(
        ...
        x-tick-step: none,
        y-tick-step: none,
        x-label: text(fill: blue)[$v$],
        y-label: text(fill: red)[$F$],
        name: "Fv",
        {
          plot.add(((0, 0.8), (1, 0.8)), style: (stroke: red))
          plot.add(((0, 0), (0, 1)), style: (stroke: none))
    ...
    fill: aqua,
  )[$Delta E$], [Arbeit, die in der Zeitspanne $Delta t$ verrichtet wird], [$[Delta E]=qty("1", "J")$],
...
#grid(
  ...
  [Definition], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$arrow(p)$]=m#text(fill: blue)[$arrow(v)$]$], [$[p]=qty("1", "N s")$],
  [], [$m$], [Masse des Körpers], [$[m]=qty("1", "kg")$],
  [$$#v(1em)], text(fill: blue)[$arrow(v)$], [Geschwindigkeit des Körpers], [$[v]=qty("1", "m/s")$],

  [Kraftstoss], grid.cell(
    colspan: 3,
  )[$#text(fill: red)[$arrow(F)$]Delta t=#text(fill: blue)[$Delta arrow(p)$]=#text(fill: blue)[$arrow(p)_"nach"$]-#text(fill: blue)[$arrow(p)_"vor"$]$],
  ...
  [Impulserhaltung], grid.cell(
    colspan: 3,
  )[Der Gesamtimpuls #text(fill: blue)[$arrow(p)_"tot"$] in einem abgeschlossenen System hat einen konstanten Betrag und eine konstante Richtung. Er wird von Vorgängen im System nicht beeinflusst.]
)
#pagebreak()
...
#grid(
  ...
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$arrow(u)$]=(m_1#text(fill: blue)[$arrow(v)_1$]+m_2#text(fill: blue)[$arrow(v)_2$])/(m_1+m_2)$], [$[u]=qty("1", "m/s")$],
  ...
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$arrow(u)_1$]=(2m_2#text(fill: blue)[$arrow(v)_2$]+(m_1-m_2)#text(fill: blue)[$arrow(v)_1$])/(m_1+m_2)$], [$[u_1]=qty("1", "m/s")$],
  [], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$arrow(u)_2$]=(2m_1#text(fill: blue)[$arrow(v)_1$]+(m_2-m_1)#text(fill: blue)[$arrow(v)_2$])/(m_1+m_2)$], [$[u_2]=qty("1", "m/s")$],
  [], [$m_i$], [Massen der Körper], [$[m_i]=qty("1", "kg")$],
  [$$#v(1em)], text(fill: blue)[$v_i$], [Geschwindigkeiten vor dem Stoss], [$[v_i]=qty("1", "m/s")$],
)
...
#grid(
  ...
  [Definition], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$arrow(L)$]=J #text(fill: purple)[$arrow(omega)$]$], [$[L]=qty("1", "kg m^2/s")$],
  grid.cell(rowspan: 2)[#align(center)[
      #cetz.canvas({
        import cetz.draw: *
        import cetz.vector: *
  ...
  [Drehimpulsänderung], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$Delta L$]=#text(fill: red)[$arrow(M)$] Delta t$], [$[Delta L]=qty("1", "kg m^2 /s")$],
  align(center)[
    #cetz.canvas({
      import cetz.draw: *
      import cetz.vector: *
  ...
  [Drehimpulssatz], grid.cell(
    colspan: 3,
  )[Der Gesamtdrehimpuls #text(fill: blue)[$arrow(L)_"tot"$] in einem abgeschlossenen System hat einen konstanten Betrag und eine konstante Richtung. Er wird von Vorgängen im System nicht beeinflusst.]
)
#pagebreak()
...
#grid(
  ...
  [Längenänderung], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$Delta l$]=#text(fill: blue)[$alpha$]#text(fill: green)[$l_0$]Delta T"; "#text(fill: green)[$l$]=#text(fill: green)[$l_0$] (1 + #text(fill: blue)[$alpha$]Delta T)$], [$[Delta l]=qty("1", "m")$],
  ...
  [Volumenänderung], grid.cell(
    colspan: 2,
  )[$Delta V=#text(fill: red)[$gamma$]V_0 Delta T"; "V=V_0 (1 + #text(fill: red)[$gamma$]Delta T)$], [$[Delta V]=qty("1", "m^3")$],
...
#grid(
  ..standard,
  [Temperaturänderung], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$Q$]=#text(fill: maroon)[$c$]m Delta theta.alt$], [$[Q]=qty("1", "J")$],
  [_$->$ @thermo _], text(fill: maroon)[$c$], [spezifische Wärmekapazität], [$[c]=qty("1", "J/kg/K")$],
  [$$#v(1em)], [$m$], [Masse des Mediums], [$[m]=qty("1", "kg")$],

  [Schmelzen/Erstarren], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$Q$]=#text(fill: purple)[$L_f$]m$], [$[Q]=qty("1", "J")$],
  [_$->$ @thermo _#v(1em)], text(fill: purple)[$L_f$], [spezifische Schmelzwärme], [$[L_f]=qty("1", "J/kg")$],

  grid.cell(rowspan: 2)[Verdampfen/Kondensieren \ _$->$ @thermo _], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$Q$]=#text(fill: fuchsia)[$L_v$]m$], [$[Q]=qty("1", "J")$],
...
#grid(
  ..standard,
  [Wärmeleitung], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$Delta Q$]/(Delta t)=-lambda (Delta T)/(#text(fill: green)[$Delta x$])#text(fill: red)[$A$]$], [$[(Delta Q)/(Delta T)]=qty("1", "J/s")$],
  ...
  [Wärmestrahlung], grid.cell(
    colspan: 2,
  )[$I=sigma T^4=#text(fill: aqua)[$Delta E$]/(#text(fill: red)[$A$] Delta t)$], [$[I]=qty("1", "W/m^2")$],
  grid.cell(rowspan: 2)[
    #cetz.canvas({
      import cetz.draw: *
...
#grid(
  ..standard,
  [1. Hauptsatz], grid.cell(
    colspan: 3,
  )[In einem abgeschlossenen System bleibt die Gesamtenergie konstant: \ $#text(fill: aqua)[$Delta U$]=#text(fill: aqua)[$Q$]+#text(fill: aqua)[$W$]$],
  ...
  [Kompressionsarbeit], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$W$]=-#text(fill: blue)[$p$] Delta V$], [$[W]=qty("1", "J")$],
  [], text(fill: blue)[$p$], [Druck im Gefäss], [$[p]=qty("1", "Pa")$],
  [$$#v(1em)], [$Delta V$], [Volumenänderung], [$[Delta V]=qty("1", "m^3")$],

  [Thermische Energie], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$E_"th"$]=#text(fill: maroon)[$H$]m$], [$[E_"th"]=qty("1", "J")$],
...
#grid(
  ..standard,
  [Ideale Maschine], grid.cell(
    colspan: 2,
  )[$eta_#smallcaps[Carnot]=(#text(fill: red)[$T_W$]-#text(fill: blue)[$T_K$])/#text(fill: red)[$T_W$]$], [$[eta_"Carnot"]=1$],
...
#grid(
  ..standard,
  [Druck des idealen Gases], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$p$]=1/3 rho #text(fill: blue)[$dash(v)$]^2$], [$[p]=qty("1", "Pa")$],
  [], [$rho$], [Dichte des Gases], [$[rho]=qty("1", "kg/m^3")$],
  [], [#text(fill: blue)[$dash(v)$]], [mittlere Geschwindigkeit der Teilchen#v(1em)], [$[v]=qty("1", "m/s")$],

  grid.cell(rowspan: 2)[Mittlere Energie eines Teilchens], grid.cell(
    colspan: 2,
  )[$#text(fill: aqua)[$dash(E)_1$]=3/2 k T$], [$[dash(E)_1]=qty("1", "J")$],
...
#grid(
  ..standard,
  [Kräfte zwischen Ladungen], grid.cell(
    colspan: 3,
  ...
  [#smallcaps[Coulomb]-Kraft <F_C>], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F_C$]=1/(4 pi epsilon_0) (|#text(fill: red)[$Q_1$]| |#text(fill: blue)[$Q_2$]|)/#text(fill: green)[$r$]^2$], [$[F_C]=qty("1", "N")$],
  [], [$Q_i$], [Punktladungen], [$[Q_i]=qty("1", "C")$],
  [], text(fill: green)[$r$], [Abstand zwischen den Ladungen], [$[r]=qty("1", "m")$],
  [], [$epsilon_0$], grid.cell(
    colspan: 2,
  )[Elektrische Feldkonstante \ $epsilon_0 = qty("8.854187e-12", "C/V/m")$#v(1em)],

  [Elektrische Feldstärke], grid.cell(
    colspan: 2,
  )[$#text(fill: purple)[$arrow(E)$]=#text(fill: red)[$arrow(F)_"el"$]/q$], [$[E]=qty("1", "N/C")$],
  [], text(fill: red)[$arrow(F)_"el"$], [Kraft, die auf Probeladung wirkt], [$[F_"el"]=qty("1", "N")$],
  [$$#v(1em)], [$q$], [Probeladung], [$[q]=qty("1", "C")$],

  [Spannung], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$U_"AB"$]=#text(fill: aqua)[$W_(#h(-2pt)"AB")$]/q$], [$[U_"AB"]=qty("1", "V")$],
  grid.cell(rowspan: 2)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: (thickness: 0.5pt, cap: "round"))
    ...
    fill: aqua,
  )[$W_(#h(-2pt)"AB")$], [Arbeit des elektr. Feldes zum Verschieben der Probeladung von A nach B], [$[W_"AB"]=qty("1", "J")$],
...
#grid(
  ...
  [Spannung], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$U$]=#text(fill: purple)[$E$]#text(fill: green)[$d$]$], [$[U]=qty("1", "V")$],
  [], text(fill: purple)[$E$], [Elektrische Feldstärke], [$[E]=qty("1", "N/C")$],
  [$$#v(1em)], text(fill: green)[$d$], [Plattenabstand], [$[d]=qty("1", "m")$],

  [Kapazität], grid.cell(
    colspan: 2,
  )[$C=epsilon_0 A/#text(fill: green)[$d$]=Q/#text(fill: blue)[$U$]$], [$[C]=qty("1", "F")$],
...
#grid(
  ...
  [Ohmscher Widerstand], grid.cell(
    colspan: 2,
  )[$R=#text(fill: blue)[$U$]/#text(fill: red)[$I$]$], [$[R]=qty("1", "Ohm")$],
  [$$#v(1em)], text(fill: blue)[$U$], [Spannung], [$[U]=qty("1", "V")$],

  [Widerstand langer Leiter], grid.cell(
    colspan: 2,
  )[$R=rho_"el" #text(fill: green)[$l$]/#text(fill: red)[$A$]$], [$[R]=qty("1", "Ohm")$],
    ...
    #align(center)[
      #zap.circuit({
        ...
        resistor(
          ...
          (),
          (rel: (1.5, 0)),
          i: (content: text(fill: red)[$I$], anchor: "south"),
          u: (content: text(fill: blue)[$U_1$], label-distance: 6pt),
          label: (content: $R_1$, anchor: "south", distance: 2pt),
        )
        resistor(
          "r2",
          (1.5, 0),
          (rel: (1.5, 0)),
          u: (content: text(fill: blue)[$U_2$], label-distance: 6pt),
          label: (content: $R_2$, anchor: "south", distance: 2pt),
        )
      })
    ]
  ...
  grid.cell(rowspan: 3)[Effektivwerte \
      ...
      plot.plot(
        ...
        name: "Pt",
        {
          ...
          plot.add-fill-between(
            ...
            ((0, 0), (1, 0)),
            style: (stroke: black, fill: gray.transparentize(50%)),
          )
    ...
    colspan: 3,
  )[$#text(fill: blue)[$U_"eff"$]=sqrt(dash(P) R)$ und $#text(fill: red)[$I_"eff"$]=sqrt(dash(P)/R)$],
  [$dash(P)$], [mittlere Leistung], [$[dash(P)]=qty("1", "W")$],
  [$R$#v(1em)], [Widerstand], [$[R]=qty("1", "Ohm")$],

  grid.cell(rowspan: 3)[Mittlere Leistung bei harmonischem Wechsel-strom], grid.cell(
    colspan: 2,
  )[$dash(P)=#text(fill: blue)[$hat(U)$]^2/(2 R)=(#text(fill: red)[$hat(I)$]^2R)/2$], [$[dash(P)]=qty("1", "W")$],
...
#grid(
  ..standard,
  [#smallcaps[Lorentz]-Kraft <F_L>], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F_L$]=q#text(fill: blue)[$v$]#text(fill: aqua)[$B$]$], [$[F_L]=qty("1", "N")$],
  grid.cell(rowspan: 3)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: 0.5pt)
  ...
  [Stromdurchfl. Leiter <F_Leiter>], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$F$]=#text(fill: red)[$I$]#text(fill: green)[$l$]#text(fill: aqua)[$B$]$], [$[F]=qty("1", "N")$],
  grid.cell(rowspan: 3)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: 0.5pt)
      ...
      line(
        (v => cetz.vector.add(v, (0, -0.5)), "draht.center"),
        (v => cetz.vector.add(v, (0, 0.5)), "draht.center"),
        stroke: red,
        mark: (end: "barbed", scale: 0.5),
        name: "I",
  ...
  grid.cell(rowspan: 4)[Magnetische Flussdichte eines Leiters \
    ...
    colspan: 2,
  )[$#text(fill: aqua)[$B$]=mu_0 #text(fill: red)[$I$]/(2 pi #text(fill: green)[$r$])$], [$[B]=qty("1", "T")$],
  ...
  grid.cell(rowspan: 5)[Magnetische Flussdichte einer schlanken Spule \
    ...
    colspan: 2,
  )[$#text(fill: aqua)[$B$]=mu_0 N/#text(fill: green)[$l$] #text(fill: red)[$I$]$], [$[B]=qty("1", "T")$],
  text(fill: red)[$I$], [Stromstärke], [$[I]=qty("1", "A")$],
          ...
          z: 10deg,
          {
            ...
            for x in (-0.2, 0, 0.2) {
              for z in (-0.2, 0, 0.2) {
                ...
                line(
                  (x + 1.3, 0, z + 0.3),
                  (rel: cetz.vector.scale((-1.3, 1, 0), a)),
                  stroke: aqua,
                  mark: (end: "barbed", scale: 0.2),
                )
              }
            }
          },
  ...
  grid.cell(rowspan: 4)[Induktionsgesetz \
    #cetz.canvas({
      ...
      plot.plot(
        ...
        y-tick-step: none,
        x-label: [$t$],
        y-label: text(size: 8pt, fill: blue)[$U_"ind"$],
        name: "Fs",
        {
    ...
    colspan: 2,
  )[$#text(fill: blue)[$U_"ind"$]=-N (Delta italic(Phi))/(Delta t)=-N dot(italic(Phi))$], [$[U_"ind"]=qty("1", "V")$],
...
#grid(
  ...
  [#cetz.canvas({
    ...
    plot.plot(
      ...
      y-tick-step: none,
      x-label: [$t$],
      y-label: text(fill: green)[$y$],
      x-ticks: ((2 * calc.pi, [$T$]),),
      y-ticks: ((1, [#text(fill: green)[$hat(y)$]]),),
      name: "yt",
      {
  ...
  [#cetz.canvas({
    ...
    plot.plot(
      ...
      y-label: text(fill: blue)[$v$],
      x-ticks: ((2 * calc.pi, [$T$]),),
      y-ticks: ((1, [#text(fill: purple)[$omega$]#text(fill: green)[$hat(y)$]]),),
      name: "vt",
      {
  ...
  [#cetz.canvas({
    ...
    plot.plot(
      ...
      y-label: text(fill: red)[$a$],
      x-ticks: ((2 * calc.pi, [$T$]),),
      y-ticks: ((1, [$#text(fill: purple)[$omega$]^2$#text(fill: green)[$hat(y)$]]),),
      name: "at",
      {
...
#grid(
  ...
  [Kreisfrequenz#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: purple)[$omega$]=(2 pi)/T=2 pi f$], [$[omega]=qty("1", "1/s")$],

  [Elongation], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$y$]=#text(fill: green)[$hat(y)$] sin(#text(fill: purple)[$omega$] t - #text(fill: winkel)[$phi_0$])$], [$[y]=qty("1", "m")$],
  [], text(fill: green)[$hat(y)$], [Amplitude], [$[hat(y)]=qty("1", "m")$],
  [$$#v(1em)], text(fill: winkel)[$phi_0$], [Nullphase], [$[phi_0]=1$],

  [Geschwindigkeit#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$v$]=#text(fill: purple)[$omega$]#text(fill: green)[$hat(y)$] cos (#text(fill: purple)[$omega$] t - #text(fill: winkel)[$phi_0$])$], [$[v]=qty("1", "m/s")$],

  [Beschleunigung#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$a$]=-#text(fill: purple)[$omega$]^2#text(fill: green)[$hat(y)$]sin (#text(fill: purple)[$omega$] t - #text(fill: winkel)[$phi_0$])$], [$[a]=qty("1", "m/s^2")$],

  [Kraftgesetz], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$arrow(F)$]=-k#text(fill: green)[$arrow(y)$]$], [$[F]=qty("1", "N")$],
  ...
  [- Fadenpendel], grid.cell(
    colspan: 2,
  )[$T=2 pi sqrt(#text(fill: green)[$l$]/#text(fill: red)[$g$])$], [$[T]=qty("1", "s")$],
...
#grid(
  ...
  [Wellenfunktion], grid.cell(
    colspan: 3,
  )[$#text(fill: green)[$y$] (x, t)=#text(fill: green)[$hat(y)$] sin (2 pi(t/T minus.plus x/lambda))$],
  ...
  [Superposition#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$y_"res"$] (x, t)=#text(fill: green)[$y_1$] (x,t)+#text(fill: green)[$y_2$] (x, t)$], [$[y_"res"]=qty("1", "m")$],
  ...
  [Stehende Welle#v(1em)], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$y$] (x,t)={2#text(fill: green)[$hat(y)$] cos(2 pi x/lambda)}{sin (2 pi t/T)}$], [$[y]=qty("1", "m")$],

  [#smallcaps[Doppler]effekt], grid.cell(
    colspan: 2,
  )[$f_B=f_S (c plus.minus #text(fill: blue)[$v_B$])/(c minus.plus #text(fill: blue)[$v_S$])$], [$[f_B]=qty("1", "Hz")$],
...
#grid(
  ...
  grid.cell(rowspan: 2)[
    #cetz.canvas({
      ...
      cetz.decorations.wave(
        line("q1.center", (alfa, 1.5 + deltaS)),
        amplitude: 0.3,
        segment-length: deltaS,
        stroke: red,
      )
      ...
      cetz.angle.angle("q2.center", "d", "parallel", radius: 0.5, label-radius: 0.35, label: box(
        baseline: -0.2em,
      )[$alpha$])
  ...
  [Beugung am Doppelspalt], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$d$]=(lambda #text(fill: blue)[$l$])/#text(fill: red)[$s$]$], [$[d]=qty("1", "m")$],
  grid.cell(rowspan: 4)[
    #cetz.canvas({
      import cetz.draw: *
      set-style(stroke: 0.5pt)
      ...
      cetz.angle.angle("rot.start", "lot", "rot", radius: 1.3, label-radius: 1.15, label: box(
        baseline: -0.2em,
      )[$alpha$])
...
#grid(
  ..standard,
  [Grundfrequenz], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$f_0$]=c/(2 #text(fill: green)[$l$])$], [$[f_0]=qty("1", "Hz")$],
  grid.cell(rowspan: 2)[
    #align(left)[
      #cetz.canvas({
        import cetz-plot: *
  ...
  grid.cell(rowspan: 5)[Ausbreitungs-geschwindigkeit], grid.cell(
    colspan: 2,
  )[$c=sqrt(#text(fill: red)[$F$]/(rho A))=sqrt(#text(fill: red)[$F$]/rho_L)$], [$[c]=qty("1", "m/s")$],
...
#grid(
  ...
  [Grundfrequenz], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$f_0$]=c/(4 #text(fill: green)[$l$])$], [$[f_0]=qty("1", "Hz")$],
  grid.cell(rowspan: 2)[
    #align(left)[
      #cetz.canvas({
        import cetz-plot: *
...
#align(center)[
  #cetz.canvas({
    ...
    cetz.angle.angle(
      ...
      radius: 0.6,
      stroke: red,
      label: box(baseline: -0.2em)[#text(fill: red)[$alpha_1$]],
      label-radius: 0.4,
    )
    cetz.angle.angle(
      (0, 0),
      ...
      radius: 0.6,
      stroke: orange,
      label: box(baseline: -0.2em)[#text(fill: orange)[$alpha_r$]],
      label-radius: 0.4,
    )
    cetz.angle.angle(
      (0, 0),
      ...
      radius: 0.8,
      stroke: fuchsia,
      label: box(baseline: -0.2em)[#text(fill: fuchsia)[$alpha_2$]],
      label-radius: 0.6,
    )
...
#grid(
  ...
  [Brechungsgesetz], grid.cell(
    colspan: 3,
  )[$(sin #text(fill: red)[$alpha_1$])/(sin #text(fill: fuchsia)[$alpha_2$])=#text(fill: gray)[$n_2$]/n_1=c_1/#text(fill: gray)[$c_2$]$],
  ...
  [Grenzwinkel], grid.cell(
    colspan: 3,
  )[$sin #text(fill: fuchsia)[$alpha_G$#v(1em)]=n_1/#text(fill: gray)[$n_2$]$ für $#text(fill: gray)[$n_2$]> n_1$]
)
...
#grid(
  ...
  [
    #cetz.canvas({
      ...
      intersections("i_b", hide(line("G.end", ("G.end", 4, "F"))), "HE")
      // Brennstrahl
...
#grid(
  ...
  [Dünne Linse], grid.cell(
    colspan: 2,
  )[$D approx (1-n) (1/#text(fill: red)[$r_1$]+1/#text(fill: blue)[$r_2$])$], [$[D]=qty("1", "dpt")$],
  grid.cell(rowspan: 2)[
    #cetz.canvas({
      import cetz.draw: *
...
#grid(
  ...
  [
    #cetz.canvas({
      ...
      line((-g, 0), (rel: (0, G)), stroke: 1pt, mark: (end: "barbed"), name: "G")
      intersections("i_b", hide(line("G.end", ("G.end", 4, "F_1"))), "HE")
      // Brennstrahl
      line("G.end", "i_b.0", stroke: red)
...
#grid(
  ..standard,
  [Linsen- & Spiegelformel], grid.cell(
    colspan: 3,
  )[$1/#text(fill: green)[$f$]=1/#text(fill: red)[$g$]+1/#text(fill: blue)[$b$]$],
  grid.cell(rowspan: 3)[
    #cetz.canvas({
      import cetz.draw: *
    ...
    fill: green,
  )[$f$], [Brennweite \ $f>0$: Hohlspiegel, Sammellinse \ $f<0$: Wölbspiegel, Streulinse], [$[f]=qty("1", "m")$],
  ...
  [Abbildungsmassstab], grid.cell(
    colspan: 2,
  )[$A=#text(fill: blue)[$B$]/#text(fill: red)[$G$]=#text(fill: blue)[$b$]/#text(fill: red)[$g$]$], [$[A]=1$],
...
#grid(
  ...
  grid.cell(rowspan: 2)[
    #cetz.canvas({
      ...
      line(
        ...
        mark: (end: "barbed", scale: 2, stroke: (dash: none), width: 6pt),
        name: "oA",
      )
      ...
      cetz.angle.angle(
        ...
        inner: true,
        stroke: red,
        label: box(baseline: -0.1em)[#text(fill: red, size: 6pt)[$alpha'$]],
        label-radius: 0.3,
      )
      cetz.angle.angle(
        "auge",
        ...
        radius: 1,
        inner: true,
        label: box(baseline: -0.15em)[#text(size: 6pt)[$alpha$]],
        label-radius: 0.9,
      )
  ...
  [Mikroskop], grid.cell(
    colspan: 2,
  )[$V=(s_0 t)/(#text(fill: fuchsia)[$f_"Ok"$] #text(fill: purple)[$f_"Ob"$])$], [$[V]=qty("1", "m")$],
  grid.cell(rowspan: 4)[
    #cetz.canvas({
      import cetz.draw: *
      ...
      line(
        (0, -1),
        (0, 2.7),
        stroke: (paint: gray, dash: "dash-dotted"),
        mark: (end: "barbed", scale: 2, stroke: (paint: black, dash: none), width: 6pt),
        name: "oA",
      )
      ...
      on-layer(1, circle(
        (v => cetz.vector.add(v, (0, 2 * f_l)), lampe),
        radius: 0.5pt,
        fill: green,
        stroke: green,
        name: "F_l1",
      ...
      line(
        (v => cetz.vector.add(v, (-0.25, f_l)), lampe),
        (rel: (0.5, 0)),
        mark: (symbol: "barbed", scale: 0.5),
        stroke: green,
        name: "kondensor",
      )
      ...
      line(
        (v => cetz.vector.add(v, (-B / 2, b)), "Ob"),
        (rel: (B, 0)),
        stroke: blue + 1pt,
        mark: (start: "barbed", scale: 0.5),
        name: "B",
      )

      // Okular
      line(
        (v => cetz.vector.add(v, (-0.5, b + f_Ok)), "Ob"),
        (rel: (1, 0)),
        mark: (symbol: "barbed", scale: 0.5),
        name: "Ok",
      )
...
#align(center + horizon)[
  #cetz.canvas({
    ...
    cetz.angle.angle(
      ...
      inner: true,
      stroke: black,
      label: box(baseline: -0.1em)[#text(size: 6pt)[$alpha$]],
      label-radius: 0.5,
    )
    cetz.angle.angle(
      "Ob",
    ...
    #cetz.canvas({
      ...
      set-style(
        axes: (
          ...
          stroke: 0.5pt,
          tick: (stroke: 0.5pt),
          x: (mark: (end: "barbed", scale: 0.5)),
          y: (mark: (end: "barbed", scale: 0.5)),
        ),
        stroke: 0.5pt,
      )
      ...
      plot.plot(
        ...
        x-tick-step: none,
        y-tick-step: none,
        x-label: text(size: 8pt)[$t$],
        y-label: text(size: 8pt, fill: blue)[$N$],
        x-ticks: ((T_Halb, text(size: 8pt)[$T_½$]),),
        y-ticks: ((1, text(size: 8pt, fill: blue)[$N_0$]),),
        name: "at",
        {
  ...
  grid.cell(rowspan: 4)[#smallcaps[Lambert-Beersches]\ Gesetz \ #v(-0.75em)
    #cetz.canvas({
      ...
      plot.plot(
        ...
        x-tick-step: none,
        y-tick-step: none,
        x-label: text(size: 8pt)[$x$],
        y-label: text(size: 8pt, fill: red)[$I$],
        x-ticks: ((d_Halb, text(size: 8pt)[$d_½$]),),
        y-ticks: ((1, text(size: 8pt, fill: red)[$I_0$]),),
        name: "at",
        {
...
#grid(
  ...
  [Längenkontraktion], grid.cell(
    colspan: 2,
  )[$#text(fill: green)[$l$]=#text(fill: green)[$l_0$]/gamma$], [$[l]=qty("1", "m")$],
  ...
  grid.cell(rowspan: 3)[#smallcaps[Lorentz]transformation \
    ...
    colspan: 3,
  )[$#text(fill: red)[$x'$]=gamma(x-#text(fill: blue)[$v$]t)$; $x=gamma(#text(fill: red)[$x'$]+#text(fill: blue)[$v$]#text(fill: red)[$t'$])$ \
    $#text(fill: red)[$y'$]=y$ \
    $#text(fill: red)[$z'$]=z$ \
    $#text(fill: red)[$t'$]=gamma(t-#text(fill: blue)[$v$]/c^2 x)$; $t=gamma(#text(fill: red)[$t'$]+#text(fill: blue)[$v$]/c^2#text(fill: red)[$x'$])$],
  text(
    fill: blue,
  )[$v$], [Geschwindigkeit von #text(fill: red)[$I'$] bzgl. $I$ in $x$-Richtung], [$[v]=qty("1", "m/s")$],
  [$c$], grid.cell(colspan: 2)[Lichtgeschwindigkeit im Vakuum \ $c=qty("299792458", "m/s")$#v(1em)],
  ...
  grid.cell(rowspan: 4)[Addition der Geschwindigkeiten \
    ...
    colspan: 3,
  )[$#text(fill: red)[$u'$]=(#text(fill: black)[$u$]-#text(fill: blue)[$v$])/(1-(#text(fill: black)[$u$]#text(fill: blue)[$v$])/c^2)$;
  ...
  text(
    fill: blue,
  )[$v$], [Geschwindigkeit von #text(fill: red)[$I'$] bzgl. $I$ in $x$-Richtung#v(1em)], [$[v]=qty("1", "m/s")$],
...
#grid(
  ...
  [Impuls], grid.cell(
    colspan: 2,
  )[$#text(fill: blue)[$arrow(p)$]=gamma m_0 #text(fill: blue)[$arrow(v)$]$], [$[p]=qty("1", "N s")$],
  [], [$m_0$], [Ruhemasse des Teilchens], [$[m_0]=qty("1", "kg")$],
  ...
  [Gesamtenergie], grid.cell(
    colspan: 2,
  )[$E=gamma E_0=sqrt((m_0 c^2)^2+(#text(fill: blue)[$p$] c)^2)$], [$[E]=qty("1", "J")$],
...
#grid(
  ...
  [Zeicheneinheit], grid.cell(
    colspan: 2,
  )[$#text(fill: red)[$e'$]=e sqrt(1+(#text(fill: blue)[$v$]/c)^2)/sqrt(1-(#text(fill: blue)[$v$]/c)^2)$], [$[e']=qty("1", "Ls/cm")$],
  grid.cell(rowspan: 3)[
    #v(-1em)
    #cetz.canvas({
      import cetz.draw: *
      ...
      cetz.angle.angle(
        ...
        inner: true,
        stroke: red,
        label: box(baseline: -0.2em)[#text(fill: red)[$alpha$]],
        label-radius: 0.75,
      )
      cetz.angle.angle(
        (0, 0),
...
#grid(
  ...
  [#smallcaps[De Broglie]], grid.cell(
    colspan: 3,
  )[Der Zusammenhang zwischen Impuls und Wellenlänge gilt auch für Teilchen#v(1em)],

  [Äusserer Photoeffekt], grid.cell(
    colspan: 2,
  )[$E_"Ph"=#text(fill: aqua)[$W_A$]+#text(fill: blue)[$E_"kin"$]$], [$[E_"Ph"]=qty("1", "J")$],
  ...
  grid.cell(rowspan: 2)[#smallcaps[Heisenberg]sche Unschärferelation], grid.cell(
    colspan: 3,
  )[$#text(fill: green)[$Delta x$] #text(fill: blue)[$Delta p_x$] >= h$; $#text(fill: aqua)[$Delta E$] Delta t >= h$],
  text(
    fill: green,
  )[$Delta x$], [Ortsunschärfe bei gleichzeitiger Messung von $x$ und $p_x$], [$[Delta x]=qty("1", "m")$],
  [], text(
    fill: blue,
  )[$Delta p_x$], [Impulsunschärfe bei gleich-zeitiger Messung von $x$ und $p_x$], [$[Delta p]=qty("1", "N s")$],
  [], text(
    fill: aqua,
  )[$Delta E$], [Energieunschärfe bei gleich-zeitiger Messung von $E$ und $t$], [$[Delta E]=qty("1", "J")$],
...
#figure(
  table(
    ...
    table.header(
      align(horizon)[Name],
      [$m \ "in "qty("e24", "kg")$],
      [$#text(fill: green)[$r$] \ "in "qty("e6", "m")$],
      [$#text(fill: aqua)[$a$] \ "in "qty("e9", "m")$],
      [$T\ "siderisch"$],
      align(horizon)[$epsilon$],
    ),
  ...
  [
    #figure(
      table(
        ...
        table.header([Strahlungsart], [$q$-Faktor]),
        table.hline(start: 0, stroke: 0.5pt),
...
#figure(
  table(
    ...
    stroke: none,
    table.header(
      align(horizon)[Brennmaterial],
      align(center)[#text(fill: maroon)[$H$] \ in $qty("e6", "J/kg")$],
      align(horizon)[Brennmaterial],
      align(center)[#text(fill: maroon)[$H$]\ in $qty("e6", "J/kg")$],
    ),
    table.hline(start: 0, stroke: 0.5pt),
...
#figure(
  grid(
    ...
    [#table(
      columns: 3 * (2fr, 1fr),
      stroke: none,
      table.header(table.cell(colspan: 6)[Feste Stoffe bei $qty("20", "Celsius")$ in $unit("kg/m^3")$]),
      table.hline(start: 0, stroke: 0.5pt),
    ...
    [#table(
      columns: 3 * (2fr, 1fr),
      stroke: none,
      table.header(table.cell(colspan: 6)[Flüssigkeiten bei $qty("20", "Celsius")$ in $unit("kg/m^3")$]),
      table.hline(start: 0, stroke: 0.5pt),
      table.vline(x: 2, stroke: 0.5pt),
      table.vline(x: 4, stroke: 0.5pt),
...
#figure(
  grid(
    ...
    [#table(
        ...
        stroke: none,
        table.header(
          align(left + horizon)[Festkörper],
          align(center)[#text(fill: blue)[$alpha$] $qty("e-6", "1/K")$],
          align(center)[#text(fill: maroon)[$c$] $unit("J/kg/K")$],
          align(center)[#text(fill: purple)[$L_f$]  $qty("e5", "J/kg")$],
          align(center)[#text(fill: fuchsia)[$L_v$] $qty("e5", "J/kg")$],
          align(center)[$lambda$ $unit("W/m/K")$],
        ),
        table.hline(start: 0),
    ...
    [#table(
        ...
        stroke: none,
        table.header(
          align(left + horizon)[Flüssigkeiten],
          align(center)[#text(fill: red)[$gamma$] $qty("e-3", "1/K")$],
          align(center)[#text(fill: maroon)[$c$]$unit("J/kg/K")$],
          align(center)[#text(fill: purple)[$L_f$]  $qty("e5", "J/kg")$],
          align(center)[#text(fill: fuchsia)[$L_v$] $qty("e5", "J/kg")$],
          align(center)[$lambda$ $unit("W/m/K")$],
    ...
    [#table(
        ...
        stroke: none,
        table.header(
          align(left + horizon)[Gase],
          [],
          align(center)[#text(fill: maroon)[$c_p$] $unit("J/kg/K")$],
          align(center)[#text(fill: purple)[$L_f$]  $qty("e5", "J/kg")$],
          align(center)[#text(fill: fuchsia)[$L_v$] $qty("e5", "J/kg")$],
          align(center)[$lambda$ $unit("W/m/K")$],
        ),
    ...
    #figure(
      grid(
        ...
        [#table(
          ...
          align: (left, right),
          stroke: none,
          table.header(table.cell(colspan: 4)[Leiter bei $qty("20", "Celsius")$ in $qty("e-8", "Ohm meter")$]),
          table.hline(start: 0, stroke: 0.5pt),
          table.vline(x: 2, stroke: 0.5pt),
        ...
        [#table(
          ...
          align: (left, right),
          stroke: none,
          table.header(table.cell(colspan: 4)[Halbleiter bei $qty("20", "Celsius")$ in $unit("Ohm meter")$]),
          table.hline(start: 0, stroke: 0.5pt),
          table.vline(x: 2, stroke: 0.5pt),
        ...
        [#table(
          ...
          align: (left, right),
          stroke: none,
          table.header(table.cell(colspan: 4)[Isolatoren bei $qty("20", "Celsius")$ in $unit("Ohm meter")$]),
          table.hline(start: 0, stroke: 0.5pt),
          table.vline(x: 2, stroke: 0.5pt),
...
#align(right + bottom)[#text(
  size: 7pt,
)[#ccicon("cc-by-sa//de", link: true) Diese Formelsammlung ist lizenziert mit einer CC-BY-SA 4.0 International Lizenz durch Christian Prim]]
#pagebreak()
